"""add tax_rate to room_types

Revision ID: 880da834570a
Revises: 408e6a775312
Create Date: 2026-02-16 00:07:31.751862
...
revision = '880da834570a'
down_revision = '408e6a775312'
branch_labels = None
depends_on = None


def upgrade():
    # Add tax_rate column to room_types table
